...
import com.kjwon.cloud.security.WithMockJwtAuthentication;
...
class UserRestControllerTest {
    ...
    void meSuccessTest() throws Exception {
        ResultActions result = mockMvc.perform(
                get("/api/users/me")
                        .accept(MediaType.APPLICATION_JSON)
                        .header(jwtTokenConfigure.getHeader(), "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJyb2xlcyI6WyJST0xFX1VTRVIiXSwiaXNzIjoia2p3b24iLCJuYW1lIjoidGVzdGVyIiwiaWF0IjoxNjQ5NDY5NDQ2LCJ1c2VyS2V5IjoxfQ.P_syCc5RzaX0XNRTwCdZnY0oj1kSufKYCn7rbEgsSI594V4Ma2FBWx6G97hnCt_HtMnQTp60cSPR-eBO_acGnQ")
        );
        result.andDo(print())
                .andExpect(status().isOk())
                .andExpect(handler().handlerType(UserRestController.class))
